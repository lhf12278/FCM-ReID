...
def main_worker(args):
    ...
    for epoch in range(args.epochs):
        with torch.no_grad():
            ...
            # labels = torch.cat([labels[f].unsqueeze(0) for f, _, _ in sorted(dataset.train)], 0).numpy()
...
if __name__ == '__main__':
    ...
    parser.add_argument('-pp', '--pretrained-path', type=str, default='/home/a/data/hqs/reid_data/vit_small_cfs_lup.pth')
    # /home/a/data/hqs/reid_data/vit_small_cfs_lup.pth
    # /home/ps/D/data-1/hqs/2023_v2/vit_small_cfs_lup.pth
    parser.add_argument('--resume', type=str,
                        default="/home/a/data/hqs_2023_v3/code5/cluster-contrast-reid-v2/log_base_msmt/checkpoint30.pth.tar",
                        metavar='PATH')
    # /home/a/data/hqs_2023_v3/code5/cluster-contrast-reid-v2/log_base_msmt/checkpoint30.pth.tar


    # /home/ps/D/data-1/hqs/2023_v2/code7/cluster-contrast-reid-base/model_best.pth.tar  # sota
